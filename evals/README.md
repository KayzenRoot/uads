...
- `npm run eval:context` — Context Intelligence CCI1–CCI10 (local pack, shared utility, incremental reuse, delete/rename, cycles, radius, C5, unsafe paths, privacy, stale identity)
