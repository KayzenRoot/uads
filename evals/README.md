...
- `npm run eval:specialist-routing` — global-first Specialist Registry and deterministic delegation SR1–SR20 (domain/assurance coverage, minimum sufficiency, independence, bounded parallel groups, disabled/experimental fail-closed behavior, and stale/duplicate/corrupt identity)
