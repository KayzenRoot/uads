...
function validateValidation(item, errors) {
  const keys = ["testFilesPassed", "testsPassed", "testsFailed", "orchestrator", "execution", "context", "fault", "cost", "modelRouting", "specialistRouting", "specialistPolicyDigest", "builtinSpecialistCatalogDigest", "npmAudit", "packaging"];
  if (!item || extra(item, keys, "validation", errors)) return;
  for (const key of ["orchestrator", "execution", "context", "fault", "cost", "modelRouting", "specialistRouting"]) {
