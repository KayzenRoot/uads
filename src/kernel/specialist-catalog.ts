...
export const BUILTIN_SPECIALIST_PROFILES: BuiltinProfile[] = [
  ...
  profile({ specialistId: "test-engineer", kind: "core", purpose: "Design and run focused verification", coveredDomains: ["quality", "testing"], functions: ["testing"], independenceClass: "support", requiredInputs: ["Work Order and selected gates"], producesEvidence: ["test evidence"], priority: 60, notes: "Must not self-approve implementation changes." }),
  profile({ specialistId: "independent-reviewer", kind: "core", purpose: "Independently review the implementation", coveredDomains: ["quality", "certification"], functions: ["independent-review"], independenceClass: "independent-review", requiredInputs: ["diff and gate evidence"], producesEvidence: ["independent review"], priority: 70, notes: "Must use an independent session and must not implement the reviewed change." }),
  ...
  profile({ specialistId: "systems-runtime-specialist", kind: "domain", purpose: "Handle systems language, kernel/runtime, contract, event-driven, state recovery, and offline-first concerns", coveredDomains: ["rust", "kernel-runtime", "contracts", "event-driven-systems", "state-recovery", "offline-first"], functions: ["systems-runtime"], independenceClass: "support", activation: { domainAny: ["rust", "kernel-runtime", "contracts", "event-driven-systems", "state-recovery", "offline-first"] }, requiredInputs: ["runtime architecture, contracts, and state/recovery obligations"], producesEvidence: ["systems/runtime verification guidance"], priority: 155, notes: "Must not replace focused testing, security assurance, or independent certification." }),
